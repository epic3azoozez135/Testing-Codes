...
if(message.channel.type === 'dm') return;
 ...
 .setDescription(`
 -=-=-=-=-=-=-=-=-=-=
 🎖 برودكاست لـ رتبة مخصصة بدون امبد
 
 🏅 برودكاست لـ رتبة مخصصة بـ امبد
 
 📭 برودكاست للجميع بـ امبد
 
 📧 برودكاست للجميع بدون امبد
 
 🔵 برودكاست للأونلاين بدون امبد
 
 🔷 برودكاست للأونلاين بـ امبد
